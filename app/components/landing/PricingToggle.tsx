...
const PLANS = [
  {
    ...
    period: "",
    badge: null,
    description: "Real data, no commitment.",
    features: [
      "AIRE Estimate — instant property valuations",
      "Market Pulse — live Baton Rouge MLS data",
      "Flood Vision — parish-level flood risk",
    ],
    cta: "Try Free Tools",
  ...
  },
  {
    ...
    period: "/mo",
    badge: "Advanced",
    description: "For agents building a portfolio.",
    features: [
      "Everything in Pro",
      "Deal DNA — full investment breakdown",
      "Cash flow projections per property",
      "Portfolio tracking across deals",
