...
export default async function MLSInputPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
      <div className="mb-8">
        <h1 className="font-[family-name:var(--font-cormorant)] italic text-cream text-3xl font-light">
          MLS Auto-Fill
        </h1>
        <p className="font-mono text-[10px] text-warm/60 tracking-wider uppercase mt-1.5">
