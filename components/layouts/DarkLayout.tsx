...
const NAV_ITEMS = [
  ...
  { href: "/aire/tools/buyers", label: "Buyer Tools", icon: "calculator", desc: "PITI, flood zone, programs" },
  { href: "/aire/tools/sellers", label: "Seller Tools", icon: "home", desc: "CMA, net proceeds, checklist" },
